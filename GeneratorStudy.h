...
double TOTAL_2NU_EVENTS[2]={1e7 / 0.044, 5e6}; // For Se82: I used a 1e7 sample that was only events with summed energy 2MeV and over. When I ran a full 1e7 sample, the %age that was over 2MeV was 4.4% 
