...
double TOTAL_2NU_EVENTS[2]={6e7 / 0.044, 5e6}; // For Se82: I used a 6e7 sample that was only events with summed energy 2MeV and over. When I ran a full 1e7 sample, the %age that was over 2MeV was 4.4%
//double FRAC_OVER_2MEV[2]={1,0.0982};
int ATOMIC_MASS[2]={82,150}; //Selenium 82, Neodymium 150
double HALFLIFE2NU[2]={9.39e19,9.1e18}; // 2nubb halflife in years
